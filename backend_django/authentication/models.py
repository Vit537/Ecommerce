...
class UserManager(BaseUserManager):
    ...
    def create_user(self, email, first_name, last_name, password=None, **extra_fields):
        ...
        user = self.model(
            ...
            last_name=last_name,
            username=username,  # Set username to email for compatibility
            **extra_fields
        )
...
class User(AbstractUser):
    ...
    Sistema de roles para tienda de ropa
    """
    ROLE_CHOICES = [
        ('admin', 'Administrador'),
        ('employee', 'Empleado'),
    ...
    is_active_employee = models.BooleanField(default=False)  # Para empleados activos
    hire_date = models.DateField(blank=True, null=True)  # Para empleados
    salary = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)  # Para empleados
    department = models.CharField(max_length=50, blank=True, null=True)  # Para empleados
    ...
    def can_view_sales_reports(self):
